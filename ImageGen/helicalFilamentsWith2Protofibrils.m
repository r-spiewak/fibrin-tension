...
for ip=1:np
    for iff=1:nf
        ...
        elseif drawCircleLines==4
            circleLocus=22.5;
            while circleLocus<=sfSize
                if mod(circleLocus,2)
                    surf((z(:,ceil(circleLocus)-circleWidth:ceil(circleLocus)+circleWidth)+z(:,floor(circleLocus)-circleWidth:floor(circleLocus)+circleWidth))/2,(x(:,ceil(circleLocus)-circleWidth:ceil(circleLocus)+circleWidth)+x(:,floor(circleLocus)-circleWidth:floor(circleLocus)+circleWidth))/2,(y(:,ceil(circleLocus)-circleWidth:ceil(circleLocus)+circleWidth)+y(:,floor(circleLocus)-circleWidth:floor(circleLocus)+circleWidth))/2,'FaceColor','k');
                elseif circleLocus>0
                    surf(z(:,circleLocus-circleWidth:circleLocus+circleWidth),x(:,circleLocus-circleWidth:circleLocus+circleWidth),y(:,circleLocus-circleWidth:circleLocus+circleWidth),'FaceColor','k');
                end
                circleLocus=circleLocus+22.5;
            end
        end
